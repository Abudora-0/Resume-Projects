...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "Nexus",
    year: "2026",
    tagline: "Chat with your documents, fully local, no API keys, nothing leaves your machine.",
    designLanguage:
    ...
    glyph: "hexagon",
    description:
      "Upload a PDF or text file and ask questions about it, powered by retrieval augmented generation on local models via Ollama. Documents are chunked, embedded with nomic-embed-text and stored in LanceDB for vector search. Answers stream token by token over Server-Sent Events with source citations for every claim, plus full document summarisation and browser-persisted chat history.",
    highlights: [
      "Local-first RAG pipeline on Ollama, LanceDB and nomic-embed-text",
      "Token-streamed answers over SSE with per-chunk source citations",
      "FastAPI backend, React 19 and Vite frontend, no cloud dependency",
    ],
    stack: ["FastAPI", "Python", "React 19", "Vite", "TypeScript", "Ollama", "LanceDB"],
    accent: "#22d3ee",
    source: "https://github.com/Abudora-0/Nexus",
    runNote: "Local-first, runs on your machine",
  },
  {
    slug: "typeset",
    name: "Typeset",
